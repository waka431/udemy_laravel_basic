      ...
      <div class="flex flex-wrap -m-2">
        ...
        <div class="p-2 w-full">
          <div class="relative">
            ...
            <input type="radio" name="gender" value= "0" {{ old('gender') == 0 ? 'checked' :''}}>男性<!--三項演算子。数字が入っていなかったら空欄-->
            <input type="radio" name="gender" value= "1" {{ old('gender') == 1 ? 'checked' :''}}>女性<!--115 oldヘルパ関数。バリデーションではじかれても値を保持-->
          </div>
        </div>
